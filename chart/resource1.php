...
$series="{ dataField: 'Rigger', displayText: 'Amount (Resource) Rigger',color:'#DCDC2B'},
									...
									{ dataField: 'Management', displayText: 'Amount (Resource) Management Region',color:'#DC143C'},
									{ dataField: 'Instalasi', displayText: 'Amount (Resource) Instalasi',color:'#423F3F'}";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title id='Description'>DASHBOARD RESOURCE REGION</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var settings4 = {
                title: "RESOURCE REGION LMT <?=$lokasi;?>",
...
<div id='jqxMenu' style='visibility: visible;'>
        <ul>
			...
			?>
            <li><a href="/chart/resource1.php?act=<?=$lokasi_id;?>&lokasi=<?=$lokasi_kerja;?>"><?=ucwords(strtolower("$lokasi_kerja"));?></a></li>
			<?PHP
			}
			?>
        </ul>
