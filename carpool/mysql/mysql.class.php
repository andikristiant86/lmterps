...
class MySQL
{
	...
	private $db_host    = "10.10.10.202:3307"; // server name
	private $db_user    = "barcode";          // user name
	private $db_pass    = "Djisamsoe5";          // password
	private $db_dbname  = "barcode";          // database name
