...
?>
<table id="dg" title="Request Pulsa" class="easyui-datagrid" style="height:475px;width:100%"
data-options="
					rownumbers:true,
					singleSelect:false,
					collapsible: true,
					url:'request_pulsaGet.php?act=view1',
					method:'post',
					pagination:true,
					toolbar:'#toolbar',
					striped: true,
...
<th field="received_date" width="100">RECEIVED DATE</th>
...
function cetak(){
	...
	window.location.assign("/carpool/request_pulsaExcel1.php?f_start_date="+start_date+"&f_end_date="+end_date);
}
