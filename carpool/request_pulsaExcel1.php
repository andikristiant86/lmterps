...
select x.*, 
	...
	from M_REQUEST_PULSA x where x.proj_id in (select id from m_project where pm_id='$login_nip') and req_date between '$f_start_date' and '$f_end_date' AND STATUS_APPROVAL='CLOSED'";
