...
header("Content-Disposition: attachment; filename=BUDGET_OPERATIONAL_$date.xls");
...
$sql="select * from t_operational_plan where $f_lkeid 
...
<b>REPORT BUDGET OPERATIONAL <?=$area_name;?> FROM DATE <?=$f_start_date;?> UP TO DATE <?=$f_end_date?></b><BR>
<table border="1" CLASS="boldtable">
        <thead>
			<tr>
				...
				<th width="130">TRANSFER/PAID DATE</th>
...
?>
			...
			<tr>
				...
				<td width="130" align="center"><?=$tgl_transfer;?></td>
