...
<table id="dg" title=":: DT ACTIVITY" class="easyui-datagrid" style="height:475px;width:100%"
data-options="
					rownumbers:true,
					singleSelect:true,
					collapsible: true,
...
<select class="easyui-combogrid" name="proj_id" style="width:50%;" required="true"
					...
					onSelect: function (index,row){
						$('#fm').form('load',{lke_id:row.lke_id});
						$('#sow').combogrid({url:'makeproposalGetnew.php?act=combo_sow&proj_idx='+row.id});
...
<div class="fitem">
<label>Cashier</label>
	<input id="kasir_id" name="kasir_id" class="easyui-combobox" style="width:50%;" required="true" data-options="
        valueField: 'lke_id',
        textField: 'lokasi_kerja',
		panelHeight:'auto',
        url: 'request_pulsaGet.php?act=combo_kasir_car'">
</div>
