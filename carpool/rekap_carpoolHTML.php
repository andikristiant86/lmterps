...
striped: true,
nowrap: false,
url: 'rekap_carpoolGet.php?act=cetak&pm_id=<?=$pm_id;?>&proj_id=<?=$proj_code;?>&f_start_date=<?=$f_start_date?>&f_end_date=<?=$f_end_date?>&lke_id=<?=$lke_id?>',
method: 'get',
toolbar:'#toolbar',
showFooter:true
">
...
<tr>
<th field="ocs_id" width="80">Req ID</th>
<th field="pm_name" width="150">Project Manager</th>
...
<thead>
<tr>
				<th field="dt_coord" width="150">COORDINATOR</th>
				<th field="dt_name" width="150">DT/SURVEYOR</th>
				<th field="uang_pulsa" width="100" align="right">UANG PULSA</th>
